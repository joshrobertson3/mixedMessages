...
- add conjunctions, adverbs, prepositions
- turn assembleClause function into a switch to create different types of clauses (for things like passive, subjunctive, tense)
